@extends('layout.user')
@section('title', 'Device Dashboard')
...
@section('content')
            ...
            <div class="card">
                <div class="card-header" style="background-color: #DAD7D7">
                    <div class="row d-flex justify-content-between align-items-center" >
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="d-flex flex-column flex-sm-row gap-2 justify-content-lg-end mt-2 mt-lg-0">
                                <input type="text" class="form-control form-control-sm" id="historicalChartStartDate"
                                    placeholder="Start Date" autocomplete="off" />
                                <input type="text" class="form-control form-control-sm" id="historicalChartEndDate"
                                    placeholder="End Date" autocomplete="off" />
                                <button class="btn btn-sm btn-primary" id="loadHistoricalChart">
    ...
    <style>
        ...
        #historicalChartStartDate,
        #historicalChartEndDate {
            min-width: 140px;
        }
        ...
        @media (max-width: 768px) {
            ...
            /* Stack date inputs vertically on small tablets */
            #historicalChartStartDate,
            #historicalChartEndDate {
                width: 100%;
            }
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function initializeHistoricalChart() {
                ...
                $('#historicalChartStartDate').val(formatDateTime(twoDaysAgo));
                $('#historicalChartEndDate').val(formatDateTime(today));
